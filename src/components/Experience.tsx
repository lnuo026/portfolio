      ...
      <article className="rounded-2xl border border-[var(--border)] bg-[var(--bg-elevated)] p-6 sm:p-7">
        ...
        <ul className="mt-3 flex flex-col gap-1.5">
          {[
            ...
            "Managed the company's social media channels (WeChat, Douyin, Xiaohongshu/RED) and online community; wrote promotional copy, internal reports, and admin documents.",
